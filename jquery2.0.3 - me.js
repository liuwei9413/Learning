...
/*extend : JQ的继承方法 开始*/
    jQuery.extend = jQuery.fn.extend = function() {
        ...
        for (; i < length; i++) {
            // Only deal with non-null/undefined values 只处理非空/未定义的值
            if ((options = arguments[i]) != null) {
                ...
                for (name in options) {
                    ...
                    if (deep && copy && (jQuery.isPlainObject(copy) || (copyIsArray = jQuery.isArray(copy)))) {
                        ...
                        // Never move original objects, clone them 从不移动原始对象,克隆他们
...
/*Callbacks : 回调对象 : 对函数的统一管理 结束*/



/*Deferred : 延迟对象 : 对异步的统一管理 开始*/
    jQuery.extend({
...
/*queue() : 队列方法 : 执行顺序的管理 结束*/



/*attr() prop() val() addClass()等 : 对元素属性的操作 开始*/
...
/*attr() prop() val() addClass()等 : 对元素属性的操作 结束*/




/* on() trigger() : 事件操作的相关方法 开始*/
    var rkeyEvent = /^key/,
...
/*提交的数据和ajax() : ajax() load() getJSON() 开始*/
    var r20 = /%20/g,
        rbracket = /\[\]$/,
        rCRLF = /\r?\n/g,
...
/*提交的数据和ajax() : ajax() load() getJSON() 结束*/
...
/*jq对外接口 window.jQuery = window.$ = jQuery; 开始*/
    // If there is a window object, that at least has a document property,
    // define jQuery and $ identifiers
    if (typeof window === "object" && typeof window.document === "object") {
        window.jQuery = window.$ = jQuery;
    }
/*jq对外接口 window.jQuery = window.$ = jQuery; 结束*/
})(window);
